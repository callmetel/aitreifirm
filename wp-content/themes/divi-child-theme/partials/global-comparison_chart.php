    ...
    <div class="et_pb_column et_pb_column_4_4 et_pb_css_mix_blend_mode_passthrough">
      <div class="chart-heading et_pb_text et_pb_module et_pb_text_align_center">
        <div class="et_pb_text_inner">
          <h2 class="h3 chart-title">Why Choose AIT?</h2>
          <p class="chart-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
        </div>
      </div>
      <div class="comparison-chart-wrapper et_pb_code et_pb_module">
        <div class="et_pb_code_inner">
          <div class="comparison-chart">
            ...
            <div class="chart-cell chart-cell-ait">As Soon as 7 days from Signing Agreement</div>
          </div>
        </div>
      </div>
    </div>
