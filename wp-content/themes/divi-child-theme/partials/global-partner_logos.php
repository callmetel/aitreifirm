    ...
    <div class="et_pb_column et_pb_column_1_4 et_pb_css_mix_blend_mode_passthrough">
      <div class="partner-logos-title-wrap et_pb_text et_pb_module et_pb_text_align_left">
        <div class="et_pb_text_inner">
        	<p class="partner-logos-title">Proud Partners of</p>
        </div>
      </div>
    </div>
    <div class="et_pb_column et_pb_column_3_4 et_pb_css_mix_blend_mode_passthrough">
      <div class="partner-logos et_pb_code et_pb_module">
        <div class="et_pb_code_inner">
        	<div class="logo"><img src="<?php echo site_url('/wp-content/uploads/logo-1.png'); ?>" alt=""></div>
        	<div class="logo"><img src="<?php echo site_url('/wp-content/uploads/logo-2.png'); ?>" alt=""></div>
        	<div class="logo"><img src="<?php echo site_url('/wp-content/uploads/logo-3.png'); ?>" alt=""></div>
        	<div class="logo"><img src="<?php echo site_url('/wp-content/uploads/logo-4.png'); ?>" alt=""></div>
        </div>
      </div>
    </div>
  </div>
